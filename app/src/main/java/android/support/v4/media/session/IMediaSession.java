...
public interface IMediaSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMediaSession {
        ...
        private static class Proxy implements IMediaSession {
            ...
            public int getRatingType() {
                ...
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getRatingType, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
            ...
            public void playFromUri(Uri uri, Bundle bundle) {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_playFromUri, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
                } catch (Throwable th) {
        ...
        public boolean onTransact(int i2, Parcel parcel, Parcel parcel2, int i3) {
            if (i2 == TRANSACTION_rateWithExtras) {
    ...
    void setShuffleModeEnabledRemoved(boolean z2);
