...
public final class MediaControllerCompat {
    ...
    private static class MediaControllerExtraData extends h.a {
    ...
    public MediaControllerCompat(Context context, MediaSessionCompat mediaSessionCompat) {
        ...
        try {
            ...
            mediaControllerImplApi24 = i2 >= 24 ? new MediaControllerImplApi24(context, sessionToken) : i2 >= 23 ? new MediaControllerImplApi23(context, sessionToken) : new MediaControllerImplApi21(context, sessionToken);
        } catch (RemoteException e) {
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        if (activity instanceof androidx.core.app.h) {
            MediaControllerExtraData mediaControllerExtraData = (MediaControllerExtraData) ((androidx.core.app.h) activity).d0(MediaControllerExtraData.class);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        if (activity instanceof androidx.core.app.h) {
            ((androidx.core.app.h) activity).e0(new MediaControllerExtraData(mediaControllerCompat));
        }
        ...
        private static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            protected void onReceiveResult(int i2, Bundle bundle) {
                ...
                synchronized (mediaControllerImplApi21.mLock) {
                    mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(androidx.core.app.g.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
