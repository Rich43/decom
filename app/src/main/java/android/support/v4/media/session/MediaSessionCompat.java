...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        private class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((androidx.media.b) message.obj);
                }
            }
        }
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            androidx.core.app.g.b(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, iBinderAsBinder);
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            androidx.media.b currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        public final androidx.media.b getCurrentControllerInfo() {
            return new androidx.media.b(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private androidx.media.b mRemoteUserInfo;
        int mRepeatMode;
        ...
        androidx.media.h mVolumeProvider;
        int mVolumeType;
        ...
        private h.a mVolumeCallback = new h.a() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            public void onVolumeChanged(androidx.media.h hVar) {
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new androidx.media.b("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
            ...
            public boolean sendMediaButton(KeyEvent keyEvent) {
                boolean z2 = (MediaSessionImplBase.this.mFlags & 1) != 0;
                if (z2) {
        ...
        class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new androidx.media.b(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(androidx.core.app.g.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
        ...
        public Bundle toBundle() {
            ...
            if (iMediaSession != null) {
                androidx.core.app.g.b(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
            }
    ...
    private MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (context != null) {
            if (!TextUtils.isEmpty(str)) {
                if (componentName == null && (componentName = J.a.a(context)) == null) {
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new androidx.media.b(callingPackage, Binder.getCallingPid(), Binder.getCallingUid()));
            }
