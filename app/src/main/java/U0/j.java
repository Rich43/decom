...
public final class j {
    ...
    private static final j[] f938f = b();
    ...
    public static j g(int i2) throws C0384f {
        if (i2 % 4 != 1) {
            throw C0384f.a();
        }
        try {
    ...
    D0.b a() {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            int i4 = this.f940b[i3] - 2;
            for (int i5 = 0; i5 < length; i5++) {
                if ((i3 != 0 || (i5 != 0 && i5 != length - 1)) && (i3 != length - 1 || i5 != 0)) {
                    bVar.m(this.f940b[i5] - 2, i4, 5, 5);
                }
            }
        }
        int i6 = iE - 17;
    ...
    public int e() {
        return (this.f939a * 4) + 17;
    }

    public b f(f fVar) {
        return this.f941c[fVar.ordinal()];
    }
    ...
    public String toString() {
        return String.valueOf(this.f939a);
    }
}
