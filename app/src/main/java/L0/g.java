...
final class g {
    ...
    private final List f297a = new ArrayList();

    /* renamed from: b, reason: collision with root package name */
    private final List f298b = new ArrayList();
    ...
    String c(String str) throws NumberFormatException {
        ...
        for (int i4 = 0; i4 < size && i3 >= (i2 = (iArr = (int[]) this.f297a.get(i4))[0]); i4++) {
            if (iArr.length != 1) {
                i2 = iArr[1];
            }
            if (i3 <= i2) {
                return (String) this.f298b.get(i4);
            }
        }
        return null;
    }
