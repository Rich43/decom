...
final class PicassoDrawable extends BitmapDrawable {
    ...
    PicassoDrawable(Context context, Bitmap bitmap, Drawable drawable, Picasso.LoadedFrom loadedFrom, boolean z2, boolean z3) {
    ...
    static void setBitmap(ImageView imageView, Context context, Bitmap bitmap, Picasso.LoadedFrom loadedFrom, boolean z2, boolean z3) {
