...
public class JsonReader implements Closeable {
    ...
    static {
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() { // from class: com.google.gson.stream.JsonReader.1
            ...
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                ...
                if (iDoPeek == JsonReader.PEEKED_SINGLE_QUOTED_NAME) {
                    jsonReader.peeked = 8;
                    return;
                }
    ...
    private boolean isLiteral(char c2) throws IOException {
        if (c2 == '\t' || c2 == '\n' || c2 == PEEKED_SINGLE_QUOTED_NAME || c2 == PEEKED_DOUBLE_QUOTED_NAME || c2 == ' ') {
            return false;
        }
        if (c2 != '#') {
            if (c2 == ',') {
    ...
    private int nextNonWhitespace(boolean z2) throws IOException {
        ...
        while (true) {
            ...
            if (c2 == '\n') {
                this.lineNumber++;
                this.lineStart = i4;
            } else if (c2 != ' ' && c2 != PEEKED_DOUBLE_QUOTED_NAME && c2 != '\t') {
                if (c2 == '/') {
                    this.pos = i4;
                    if (i4 == i3) {
                        this.pos = i2;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x005c, code lost:
        ...
        r1 = new java.lang.StringBuilder(java.lang.Math.max((r2 - r3) * 2, com.google.gson.stream.JsonReader.PEEKED_NUMBER));
     */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:66:0x00ad, code lost:
        ...
        r18.peekedLong = r11;
        r18.pos += r8;
        r18.peeked = com.google.gson.stream.JsonReader.PEEKED_LONG;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:76:0x00c4, code lost:
        ...
        r18.peeked = com.google.gson.stream.JsonReader.PEEKED_NUMBER;
     */
    ...
    */
    ...
    private void skipToEndOfLine() {
        ...
        } while (c2 != PEEKED_DOUBLE_QUOTED_NAME);
    }
    ...
    public void skipValue() throws IOException {
        ...
        do {
            ...
            if (iDoPeek == 3) {
                ...
                if (iDoPeek == PEEKED_UNQUOTED_NAME || iDoPeek == 10) {
                    skipUnquotedValue();
                } else if (iDoPeek == 8 || iDoPeek == PEEKED_SINGLE_QUOTED_NAME) {
                    skipQuotedValue('\'');
                } else if (iDoPeek == 9 || iDoPeek == PEEKED_DOUBLE_QUOTED_NAME) {
                    skipQuotedValue('\"');
                } else if (iDoPeek == PEEKED_NUMBER) {
                    this.pos += this.peekedNumberLength;
                }
                this.peeked = 0;
            }
