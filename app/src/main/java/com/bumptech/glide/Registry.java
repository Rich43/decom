...
public class Registry {
    ...
    public Registry() {
        InterfaceC0342e interfaceC0342eThreadSafeList = FactoryPools.threadSafeList();
        this.throwableListPool = interfaceC0342eThreadSafeList;
        this.modelLoaderRegistry = new ModelLoaderRegistry(interfaceC0342eThreadSafeList);
    ...
    public <X> Encoder<X> getSourceEncoder(X x2) {
