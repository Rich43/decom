...
public class Glide implements ComponentCallbacks2 {
    ...
    Glide(Context context, Engine engine, MemoryCache memoryCache, BitmapPool bitmapPool, ArrayPool arrayPool, RequestManagerRetriever requestManagerRetriever, ConnectivityMonitorFactory connectivityMonitorFactory, int i2, RequestOptions requestOptions, Map<Class<?>, TransitionOptions<?, ?>> map) {
        this.engine = engine;
    ...
    public static RequestManager with(AbstractActivityC0191i abstractActivityC0191i) {
        return getRetriever(abstractActivityC0191i).get(abstractActivityC0191i);
    }
