...
public class SupportRequestManagerFragment extends Fragment {
    ...
    private void registerFragmentWithRoot(AbstractActivityC0191i abstractActivityC0191i) {
        unregisterFragmentWithRoot();
        SupportRequestManagerFragment supportRequestManagerFragment = Glide.get(abstractActivityC0191i).getRequestManagerRetriever().getSupportRequestManagerFragment(abstractActivityC0191i);
