    ...
    public void preFill(PreFillType.Builder... builderArr) {
        ...
        for (int i2 = 0; i2 < builderArr.length; i2++) {
            ...
            if (builder.getConfig() == null) {
                ...
                builder.setConfig((decodeFormat == DecodeFormat.PREFER_ARGB_8888 || decodeFormat == DecodeFormat.PREFER_ARGB_8888_DISALLOW_HARDWARE) ? Bitmap.Config.ARGB_8888 : Bitmap.Config.RGB_565);
            }
