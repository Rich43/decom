...
public final class DefaultImageHeaderParser implements ImageHeaderParser {
    ...
    private ImageHeaderParser.ImageType getType(Reader reader) {
        ...
        int uInt162 = ((uInt16 << WEBP_EXTENDED_ALPHA_FLAG) & (-65536)) | (reader.getUInt16() & 65535);
        ...
        reader.skip(4L);
        if ((((reader.getUInt16() << WEBP_EXTENDED_ALPHA_FLAG) & (-65536)) | (reader.getUInt16() & 65535)) != WEBP_HEADER) {
            return ImageHeaderParser.ImageType.UNKNOWN;
        }
        int uInt163 = ((reader.getUInt16() << WEBP_EXTENDED_ALPHA_FLAG) & (-65536)) | (reader.getUInt16() & 65535);
        ...
        if (i2 == VP8_HEADER_TYPE_EXTENDED) {
            reader.skip(4L);
            return (reader.getByte() & WEBP_EXTENDED_ALPHA_FLAG) != 0 ? ImageHeaderParser.ImageType.WEBP_A : ImageHeaderParser.ImageType.WEBP;
        }
