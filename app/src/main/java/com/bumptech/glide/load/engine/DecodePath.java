...
public class DecodePath<DataType, ResourceType, Transcode> {
    ...
    public DecodePath(Class<DataType> cls, Class<ResourceType> cls2, Class<Transcode> cls3, List<? extends ResourceDecoder<DataType, ResourceType>> list, ResourceTranscoder<ResourceType, Transcode> resourceTranscoder, InterfaceC0342e interfaceC0342e) {
        this.dataClass = cls;
        this.decoders = list;
    ...
    private Resource<ResourceType> decodeResource(DataRewinder<DataType> dataRewinder, int i2, int i3, Options options) {
    ...
    public Resource<Transcode> decode(DataRewinder<DataType> dataRewinder, int i2, int i3, Options options, DecodeCallback<ResourceType> decodeCallback) {
