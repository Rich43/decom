...
public class Engine implements EngineJobListener, MemoryCache.ResourceRemovedListener, EngineResource.ResourceListener {
    ...
    static class DecodeJobFactory {
        ...
        final InterfaceC0342e pool = FactoryPools.simple(Engine.JOB_POOL_SIZE, new FactoryPools.Factory<DecodeJob<?>>() { // from class: com.bumptech.glide.load.engine.Engine.DecodeJobFactory.1
    ...
    static class EngineJobFactory {
        ...
        final InterfaceC0342e pool = FactoryPools.simple(Engine.JOB_POOL_SIZE, new FactoryPools.Factory<EngineJob<?>>() { // from class: com.bumptech.glide.load.engine.Engine.EngineJobFactory.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.bumptech.glide.util.pool.FactoryPools.Factory
        ...
        <R> EngineJob<R> build(Key key, boolean z2, boolean z3, boolean z4, boolean z5) {
            return ((EngineJob) Preconditions.checkNotNull((EngineJob) this.pool.acquire())).init(key, z2, z3, z4, z5);
        }
    ...
    public <R> LoadStatus load(GlideContext glideContext, Object obj, Key key, int i2, int i3, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z2, boolean z3, Options options, boolean z4, boolean z5, boolean z6, boolean z7, ResourceCallback resourceCallback) {
        ...
        EngineResource<?> engineResourceLoadFromActiveResources = loadFromActiveResources(engineKeyBuildKey, z4);
        ...
        EngineResource<?> engineResourceLoadFromCache = loadFromCache(engineKeyBuildKey, z4);
        ...
        EngineJob<?> engineJob = this.jobs.get(engineKeyBuildKey, z7);
        if (engineJob != null) {
        ...
        EngineJob<R> engineJobBuild = this.engineJobFactory.build(engineKeyBuildKey, z4, z5, z6, z7);
        DecodeJob<R> decodeJobBuild = this.decodeJobFactory.build(glideContext, obj, engineKeyBuildKey, key, i2, i3, cls, cls2, priority, diskCacheStrategy, map, z2, z3, z7, options, engineJobBuild);
