...
public abstract class b {
    ...
    private static final ThreadLocal f2845a = new ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f2846b = new ThreadLocal();
    ...
    static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f2845a;
        ...
        ThreadLocal threadLocal2 = f2846b;
