...
public abstract class c {
    ...
    /* renamed from: a */
    private static final ThreadLocal f2959a = new ThreadLocal();
    ...
    private static TypedValue c() {
        ThreadLocal threadLocal = f2959a;
    ...
    */
    ...
    private static boolean f(Resources resources, int i2) throws Resources.NotFoundException {
    ...
    private static int g(int i2, float f2, float f3) {
        ...
        int iA = AbstractC0327a.a((int) ((Color.alpha(i2) * f2) + 0.5f), 0, 255);
        if (z2) {
            a aVarC = a.c(i2);
