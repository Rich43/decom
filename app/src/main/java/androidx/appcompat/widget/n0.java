...
public class n0 extends W {
    ...
    private final WeakReference f2499b;

    public n0(Context context, Resources resources) {
        super(resources);
        this.f2499b = new WeakReference(context);
    }
    ...
    public Drawable getDrawable(int i2) {
        Context context = (Context) this.f2499b.get();
        return context != null ? V.h().t(context, this, i2) : a(i2);
    }
