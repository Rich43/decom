...
public class AlertDialogLayout extends Q {
    ...
    private static int B(View view) {
        int iZ = androidx.core.view.M.z(view);
        if (iZ > 0) {
            return iZ;
        }
    ...
    private boolean C(int i2, int i3) {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == e.i.f5920F) {
                    view = childAt;
                } else if (id == e.i.f5930k) {
                    view2 = childAt;
                } else {
                    if ((id != e.i.f5932m && id != e.i.o) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
    ...
    */
    protected void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r15 = r2
            androidx.appcompat.widget.Q$a r15 = (androidx.appcompat.widget.Q.a) r15
            int r2 = r15.gravity
            if (r2 >= 0) goto L7e
            r2 = r11
        L7e:
            int r3 = r17.getLayoutDirection()
            int r2 = androidx.core.view.AbstractC0176t.b(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L98
            r3 = 5
